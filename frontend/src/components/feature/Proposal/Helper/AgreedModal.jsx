        ...
        <div className="cs-modal ">
            <div className="layout position-rel">
                ...
                <div className="grid-cs mt-3 gtc-equal mob">
                    ...
                    <button onClick={()=>onConfirmation(true)}  className="filter-btn mob txt-deco-none bg-theme-1"><i class="fa-light fa-circle-check fa-lg" style={{ color: "#ffffff" }} /> &nbsp; Yes Agreed !!</button>
                </div>
            </div>
        </div>
    </>
